...
[dhcp_spoofing.py](/dhcp_spoofing.py)

🦈 Capture DHCP Spoofing

[dhcp_spoofing_1](/dhcp_spoofing_1)
...
2: enp0s8: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
    link/ether 08:00:27:93:02:66 brd ff:ff:ff:ff:ff:ff
    inet 10.1.1.37/24 brd 10.1.1.255 scope global dynamic enp0s8
       valid_lft 3603sec preferred_lft 3603sec
    inet6 fe80::a00:27ff:fe93:266/64 scope link
       valid_lft forever preferred_lft forever
```
```bash	
[toto@node2 ~]$ ip route | grep default
default via 10.1.1.100 dev enp0s8
```
```bash
[toto@node2 ~]$ cat /etc/resolv.conf
; generated by /usr/sbin/dhclient-script
nameserver 1.1.1.1
```
🦈 Capture DHCP Spoofing MITM

[dhcp_spoofing_2.pcap](/dhcp_spoofing_2.pcap)